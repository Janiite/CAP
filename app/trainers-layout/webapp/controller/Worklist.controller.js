sap.ui.define(
  ...
  function (BaseController, JSONModel, formatter, Filter, FilterOperator, MessageToast) {
    ...
    return BaseController.extend("demo.trainerslayout.controller.Worklist", {
      formatter: formatter,
      ...
      handleMessageToastPress: function(oEvent) {
        let msg = 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy\r\n eirmod.';
