...
], function (BaseController, JSONModel, formatter, Filter, FilterOperator, MessageToast, IconPool, Dialog, Button, mobileLibrary, List, Input, StandardListItem, Text) {
    "use strict";

    return BaseController.extend("demo.trainers.controller.Worklist", {
        ...
        _showObject : function (oItem) {
            this.getRouter().navTo("object", {
                objectId: oItem.getBindingContext().getPath().substring("/Trainers".length)
            });
        },
        ...
        onSelect : function () {
           ...
           let oFilterLocation = sLocation ? new Filter ('location_ID',  FilterOperator.EQ, sLocation) : null;
